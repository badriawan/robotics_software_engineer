...
class MazeSquare : public rclcpp::Node {
public:
  MazeSquare() : Node("maze_square") {
    ...
    _subscription = this->create_subscription<sensor_msgs::msg::LaserScan>(
      "/scan", 10, std::bind(&MazeSquare::lidarCallback, this, _1));
  }
...
int main(int argc, char * argv[]) {
  ...
  rclcpp::spin(std::make_shared<MazeSquare>());
  rclcpp::shutdown();
  return 0;
}
